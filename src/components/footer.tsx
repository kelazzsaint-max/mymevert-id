...
const PrivacyModal = dynamic(() =>
  import("./privacy-modal").then((m) => m.PrivacyModal),
);
const TermsModal = dynamic(() =>
  import("./terms-modal").then((m) => m.TermsModal),
);
const CookiesModal = dynamic(() =>
  import("./cookies-modal").then((m) => m.CookiesModal),
);
  ...
  return (
    ...
    >
      <div
        ...
        style={{
          background:
            "radial-gradient(ellipse at top, rgba(224,64,251,0.06) 0%, transparent 70%)",
        }}
      />
      ...
      <div className="relative mx-auto max-w-6xl px-4 py-12 md:py-16">
        <div className="grid gap-10 md:grid-cols-2 lg:grid-cols-4 md:gap-12">
          ...
          <div className="lg:col-span-2">
            ...
            >
              Download and convert media quickly, securely and without
              registration. Your trusted media companion.
            </p>
              ...
              {socials.map(({ name, href, icon: Icon }) => (
                <a
                  ...
                  className={cn(
                    ...
                    "border border-border-mid bg-bg-elevated text-text-secondary",
                    "transition-all duration-200 hover:border-accent-blue hover:text-accent-blue",
                  )}
                >
          ...
          <div>
            ...
            <ul
              ...
              style={{ color: "var(--text-secondary)" }}
            >
              {["Features", "How It Works", "FAQ", "Privacy Policy"].map(
                (link) => (
                  <li key={link}>
                    <a
                      href={
                      ...
                      className={cn(
                        "accent-line transition-colors duration-200",
