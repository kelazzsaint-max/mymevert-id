...
export function Hero() {
  ...
  const overlayStyle =
    "linear-gradient(to bottom, rgba(10,10,15,0.75) 0%, rgba(10,10,15,0.5) 50%, rgba(10,10,15,0.5) 100%)";
  ...
  const buttonStyle = {
    ...
    color: resolvedTheme === "light" ? "#1e293b" : "white",
    boxShadow: resolvedTheme === "light" ? "0 2px 8px rgba(0,0,0,0.1)" : "none",
  };
  ...
  return (
    <section id="hero" className="relative overflow-hidden py-16 md:py-24">
      ...
      <div className="hero-content relative z-10 mx-auto max-w-5xl px-4 text-center">
        {/* Badge */}
        <div
          className="reveal mb-6 inline-flex items-center gap-2 rounded-full border px-4 py-2 text-sm backdrop-blur-sm"
          style={{
        ...
        {/* Heading */}
        <h1
          className="reveal text-4xl font-bold tracking-tight md:text-5xl lg:text-7xl"
          style={{ fontFamily: "var(--font-display)" }}
        >
          <span className="block" style={{ color: "#e2e8f0" }}>
            Convert Media
          </span>
          <span
        ...
        <p className="reveal mx-auto mt-5 max-w-2xl text-sm leading-relaxed md:text-base lg:text-lg text-secondary">
          ...
          or grab MP3 directly from YouTube. All in one place — no registration
          needed.
        </p>
